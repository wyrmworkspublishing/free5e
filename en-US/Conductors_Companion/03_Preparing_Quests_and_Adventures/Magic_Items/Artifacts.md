...
Artifact properties are benefits or detriments with varying intensities.
An artifact can have a maximum of four lesser benefits and two greater benefits, and no more than four lesser detriments and two greater detriments.
...
| d20 | Effect |
| :---- | :---- |
| **1–4** | **Sage.** Gain proficiency in one skill (Conductor’s choice). |
| **5–6** | **Panacea.** Immune to disease. |
| **7–8** | **Mind’s Bastion.** Immune to being Charmed or Frightened. |
...
| d20 | Effect |
| :---- | :---- |
| **1** | **Magic Magnet.** Disadvantage on saving throws against spells. |
| **2** | **Ruin.** Gems and jewelry you touch lose half value. |
| **3** | **Starbound.** You glow dim light in a 20-ft. radius; creatures have advantage on checks to spot you. |
| **4** | **Bad Reaction.** Disadvantage on saving throws against poison. |
...
As the wizard towers fell, the orbs were destroyed or faded into legend, leaving only three.
Their magic has warped over the centuries, allowing some control over dragons.
Each orb contains the essence of an evil dragon, resisting attempts to coax magic from it.
Those lacking in personality might be enslaved to an orb.
An orb is an etched crystal globe about 10 inches in diameter.
When used, it grows to 20 inches in diameter, with mist swirling inside.
Attuned to an orb, you can use an action to peer into its depths and use its command word.
You must make a DC 15 Charisma check.
On a successful check, you control the orb for as long as you remain attuned.
On a failed check, you become charmed for as long as you remain attuned.
