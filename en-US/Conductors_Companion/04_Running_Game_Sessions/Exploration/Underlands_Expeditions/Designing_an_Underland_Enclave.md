### Designing an Underland Enclave
Use **Spiral design** to reveal layers of tunnels, hazards, and factions as the party pushes deeper from a single safe refuge.

## 1. Review the Characters

Consider how newcomers adapt to the dark, cramped, and vertical world below.
Consider what skills and background information would be important.
Track how they handle light, sound, climbing, and communication.
Use the **Conducting Game Sessions** and **NPC Generator** tables to decide how locals react to surface dwellers.

## 2. Create a Strong Start

Begin with motion and tension—a collapse, a flood, a swarm burst, or a standoff in a narrow tunnel.
...
The Underlands are filled with strange places—chambers of singing crystal, endless waterfalls, bridges of bone, and hollow stalactites filled with light.
