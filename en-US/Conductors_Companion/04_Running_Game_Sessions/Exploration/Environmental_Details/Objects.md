...
Can a fighter cut through a section of a stone wall with a sword?
No, the sword is likely to break before the wall does.
...
**Huge and Gargantuan Objects.** Normal weapons are of little use against many Huge and Gargantuan objects, such as a colossal statue, towering column of stone, or massive boulder.
That said, one torch can burn a Huge tapestry, and an _Earthquake_ spell can reduce a colossus to rubble.
...
Destroying one of those sections could ruin the entire object.
...
For example, bludgeoning damage works well for smashing things but not for cutting through rope or leather.
...
**Damage Threshold.** Big objects such as castle walls often have extra resilience represented by a damage threshold (DT).
...
| Object / Structure | DT |
| :---- | :---- |
| Wagon (Large, Covered) | 10 |
| Wooden Barricade | 10 |
| Tall Watchtower | 15 |
| Wooden Ship (Docked) | 15 |
| Castle Gate | 20 |
| Great Door (Oak, Reinforced) | 20 |
| Fortified Stone Wall | 25 |
| Large Stone Fountain | 25 |
| Barricaded City Wall | 30 |
| Iron Gate (Large) | 30 |
| Massive Boulder | 30 |
| Obsidian Pillar | 30 |
| Iron or Steel Bridge | 40 |
| Giant Stone Statue | 50 |
| Large Metal Vault Door | 50 |
