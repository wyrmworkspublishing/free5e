# Between Adventures
Adventurers need time to rest, recuperate, and prepare for their next adventure.
They also use this time for tasks like crafting, research, or spending gold.
Time passes without fanfare or description when starting a new adventure.
...
For example, crafting plate armor (1,500 gp) takes 300 days.
Multiple crafters may combine efforts if they share location and tool proficiency.
Each contributes 5 gp per day toward the project’s total value.
For instance, three skilled characters working together can complete plate armor in 100 days at half the total material cost (750 gp).
...
They make an Arcana or History check against the DC listed on the Research table, taking time and spending gold.
On a success, they learn the information.
Success by 5 or more grants an additional useful fact.
Failure means they learn nothing or an incorrect piece of information that could lead them astray.
The cost reflects bribes, library fees, and other expenses.
At the Conductor’s discretion, a character may dispense with these costs if they have access to a library.
