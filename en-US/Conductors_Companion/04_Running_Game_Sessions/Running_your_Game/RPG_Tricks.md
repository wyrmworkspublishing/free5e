...
- Keep a list of random names on hand to use for NPCs, villains, and monsters.
  (The [**NPC Name Generator**](#6_Outline_Important_NPCs_npc_generator) in <mark>chapter XX</mark> "Conductor Prep in Eight Steps", step 6 ["Outline Important NPCs"](#6_Outline_Important_NPCs_6_outline_important_npcs) can be useful for this.)
