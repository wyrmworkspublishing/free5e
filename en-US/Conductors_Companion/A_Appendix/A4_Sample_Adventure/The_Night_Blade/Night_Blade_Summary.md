#### Adventure Summary
<!-- spell-checker:words Gardren Ralavaz tangleweed Willowmane Whitesparrow -->

This adventure begins when the party is attacked by members of the **new Night Blades**.
After the fight, the characters investigate the scene of battle to learn more about the bandits.
...
**Monsters:**
<span class="monster monster-Bandit_bandit">Bandits<!-- CR 1/8, 25 XP each --></span> (6), <span class="monster monster-Shambling_Mound_shambling_mound">Shambling Mound<!-- CR 6, 2,300 XP --></span>, <span class="monster monster-Guard_guard">Guards<!-- CR 1/8, 25 XP each --></span> (2), <span class="monster monster-Stirge_stirge">Stirges<!-- CR 1/8, 25 XP each --></span> (10), <span class="monster monster-Thug_thug">Thugs<!-- CR 1, 200 XP each --></span> (2), <span class="monster monster-Swarm_of_Rats_swarm_of_rats">Swarm of Rats<!-- CR 1/4, 50 XP --></span>, <span class="monster monster-Bandit_Captain_bandit_captain">Bandit Captain<!-- CR 3, 700 XP --></span>
