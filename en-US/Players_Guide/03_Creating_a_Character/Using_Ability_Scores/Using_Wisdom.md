...
This is handled using a character's passive [Wisdom (Perception)](#Using_Wisdom_wisdom-checks) score, following the standard rules for [Passive Checks](#Ability_Checks_passive-checks).
